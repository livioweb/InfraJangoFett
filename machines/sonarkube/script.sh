...
docker-compose up -d
sleep 13
curl -i -XPOST http://172.17.177.50:8086/query --data-urlencode "q=CREATE DATABASE sonarkube_telegraf"
curl -i -XPOST http://172.17.177.50:8086/query --data-urlencode "q=CREATE DATABASE sonarkube_netdata"
